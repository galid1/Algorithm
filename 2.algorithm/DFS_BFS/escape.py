        ...
        while w_queue_1 :
            ...
            for k in range(4):
                ...
                if nx >= 0 and ny >= 0 and nx < len(matrix) and ny < len(matrix[0]):
                    ...
                    if (matrix[nx][ny] == '.' or matrix[nx][ny] == 'S') and matrix[nx][ny] != 'X' and matrix[nx][nx] != 'D':
        ...
        for g in range(4):
            ...
            if nx >= 0 and ny >= 0 and nx < len(matrix) and ny < len(matrix[0]):
                ...
                if matrix[nx][ny] == '.' and matrix[nx][ny] != 'X' and visit[nx][ny] == -1:
                    s_queue.append(Node(nx, ny, s_cur.count + 1))
                    visit[nx][ny] = 1
